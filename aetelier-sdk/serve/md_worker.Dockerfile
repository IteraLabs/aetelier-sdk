# aetelier-infra/dockerfiles/md_worker.Dockerfile
#
...
#                -f aetelier-infra/dockerfiles/md_worker.Dockerfile .
...
# Workspace manifests for layer caching (mirror agent.Dockerfile).
...
# Bust cargo's mtime fingerprint (same fix as agent.Dockerfile).
